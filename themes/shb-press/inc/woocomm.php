...
function g365_add_event_id_reference() {
	wp_enqueue_style( 'foundation-admin', site_url( '/wp-content/themes/shb-press/css/', 'https' ) . "style-admin.css?ver=2.4" );
...
function shb_cart_process(){
  ...
  if( !empty(WC()->cart->get_cart()) ) {
    ...
    foreach ( WC()->cart->get_cart() as $cart_item_key => $cart_item ) {
      ...
      $extra_types = array( 'fee', 'gear', 'clinics', 'tryouts', 'beach', 'beach_tryouts', 'yvl', 'club', 'parentInfo', 'team-info', 'boysclub' );
              ...
              for ($i = 1; $i <= $cart_item['quantity']; ++$i) {
                ...
                $extra_fields[] = array(
                  ...
                  'options'     => array(
                            ...
                            'Girls 9th Grade'  => "Girls 9th Grade",
                            'Girls 10th Grade'  => "Girls 10th Grade",
                            'Girls 11th Grade'  => "Girls 11th Grade",
                            'Girls 12th Grade'  => "Girls 12th Grade",
                            'Boys 8U'  => "Boys 8U",
                            'Boys 9U' => "Boys 9U",
                            'Boys 10U' => "Boys 10U",
                            'Boys 11U'  => "Boys 11U",
...
function shb_user_fields_display( $user ) {
	wp_enqueue_style( 'foundation-admin', site_url( '/wp-content/themes/shb-press/css/', 'https' ) . "style-admin.css?ver=2.345" );
	wp_enqueue_script( 'admin-jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js', array(), '2.2.4', true );
  wp_enqueue_script( 'js-g365-all', (( strpos(site_url(), 'dev.') === false ) ? 'https://grassroots365.com/data-processor.js' : 'https://dev.grassroots365.com/data-processor.js'), array('admin-jquery'), '69550', true );
  ?>
