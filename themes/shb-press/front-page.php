...
$default_event_img = get_site_url() . '/wp-content/themes/shb-press/shb_default_placeholder.gif';
$default_img = get_site_url() . '/wp-content/themes/shb-press/shb_default_placeholder.gif';
$default_vid = get_site_url() . '/wp-content/themes/shb-press/assets/videos/Beach-Email-Header.mp4';
...
if( $shb_layout_type['front_layout']['type'] === 'tiles' && count($news_feat->posts) === 6 ){
  ...
  function shb_tile_template( $target_num, $news_feat, $classes ) {
    ...
    if( empty($tile_type) ) {
      $tile_type = '<img src="' . (( has_post_thumbnail($news_feat->posts[$target_num]->ID) ) ? get_the_post_thumbnail_url( $news_feat->posts[$target_num]->ID, "featured-tile" ) : get_site_url() . "/wp-content/themes/shb-press/assets/shb_blank-placeholder_640x640.jpg") . '" alt="' . $news_feat->posts[$target_num]->post_title . '" />';
    } else {
...
<!--   <video style="height:100%; width:100%;"  controls autoplay="true" loop="true" muted>
  <source src='/wp-content/themes/shb-press/assets/videos/shb-DRONE-FACILITY.mov' type='video/mp4'>
  Your browser does not support the video tag.
  </video>
  
  <div class="welcoming-shb">
    <h1 style="float:left" class="welcome-text">WELCOME TO</h1><img src="/wp-content/themes/shb-press/assets/tiny-logos/The-Stage-Act-3-883.jpg" style="float:right" class="welcome-img"></img>
  </div> -->
  ...
  <div class="grid-x align-center">
         <img class="img-2" src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/Strictly-Hoops-Logo.png">
  </div>
...
<!--   <iframe width="560" height="315" src="https://www.youtube.com/embed/R17HN5m1rqE?&autoplay=1&loop=1&rel=0&showinfo=0&color=white&mute=1&playlist=R17HN5m1rqE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share; loop" allowfullscreen></iframe>
  ...
  <div class="welcoming-shb">
    <h1 style="float:left" class="welcome-text">WELCOME TO</h1><img src="/wp-content/themes/shb-press/assets/tiny-logos/shb-new-white.png" style="float:right" class="welcome-img"></img>
  </div> -->
...
<!-- <img style="border: #fefefe solid 10px; height:780px; width: 100%" src="/wp-content/themes/shb-press/assets/tiny-logos/Club-Accomplishments.png"> -->
...
<section class="site-main small-padding-top xlarge-padding-bottom grid-container<?php if ( $shb_ad_info['go'] ) echo $shb_ad_info['ad_section_class']; ?>">
  <?php if ( $shb_ad_info['go'] ) echo $shb_ad_info['ad_before'] . $shb_ad_info['ad_content'] . $shb_ad_info['ad_after']; ?>
  <div class="grid-x grid-margin-x">
