			...
			<div id="mastInsert" class="grid-x white header-bg">
				...
				<div class="cell shrink">
					<div id="site-logo-bar" class="grid-x collapse">
						...
						<a class="shb-logo main-logo title-logos current-site cell shrink has-tip" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/Strictly-Hoops-Logo-400x300.png" alt="<?php bloginfo( 'name' ); ?> Official Logo" /><span class="show-for-sr"><?php bloginfo( 'name' ); ?> Official Site</span></a>
            <div class="grid-x align-middle powered-container hide-for-small-only">
<!--               <p class="no-margin-bottom"> powered by</p>
              <a class="small-logo cell shrink"  href="https://opengympremier.com/" target="_blank"><img class="powered-logo" src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/OGP-Logo-Black.png" alt="Open Gym Premier Official Logo" /><span class="show-for-sr">Elite Basketball Circuit Official Site</span></a> -->
            </div>
            
<!-- 						<a class="secondary-logo title-logos cell shrink has-tip"  href="http://elitebasketballcircuit.com" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/ebc-black.png" alt="Elite Basketball Circuit Official Logo" /><span class="show-for-sr">Elite Basketball Circuit Official Site</span></a>
						<a class="secondary-logo g365-logo title-logos cell shrink has-tip"  href="https://grassroots365.com" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/g365-black.png" alt="Open Gym Premier Official Logo" /><span class="show-for-sr">Grassroots 365 Official Site</span></a>
            <a class="secondary-logo g365-logo title-logos cell shrink has-tip" href="https://sportsboardroom.com/" target="_blank"><img src="/wp-content/themes/shb-press/assets/tiny-logos/sports-boardroom.png" alt="Sports Boardroom Official Logo" /><span class="show-for-sr">Sports Boardroom Official Site</span></a> -->
					</div>
					<!--description-->
					<h3 itemprop="description" class="show-for-sr"><?php echo get_bloginfo( 'description' )?></h3>
					<!--skip to content-->
					<div class="show-on-focus skip-link"><a href="#content" title="Skip to content"><?php _e( 'Skip to content', 'shb-press' ) ?></a></div>
				</div>
      ...
      <!--logo -->
			<div id="mastInsert" class="grid-x header-bg">
				<div class="cell shrink">
					<div id="site-logo-bar" class="grid-x collapse">
            <a class="shb-logo main-logo title-logos current-site cell shrink has-tip" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/Strictly-Hoops-Logo-400x300.png" alt="<?php bloginfo( 'name' ); ?> Official Logo" /><span class="show-for-sr"><?php bloginfo( 'name' ); ?> Official Site</span></a>
            <a class="secondary-logo title-logos cell shrink has-tip"  href="https://opengympremier.com/" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/OGP-Logo-Black.png" alt="Open Gym Premier Official Logo" /><span class="show-for-sr">Elite Basketball Circuit Official Site</span></a>
<!-- 						<a class="secondary-logo title-logos cell shrink has-tip"  href="http://elitebasketballcircuit.com" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/ebc-black.png" alt="Elite Basketball Circuit Official Logo" /><span class="show-for-sr">Elite Basketball Circuit Official Site</span></a>
						<a class="secondary-logo g365-logo title-logos cell shrink has-tip"  href="https://grassroots365.com" target="_blank"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/g365-black.png" alt="Open Gym Premier Official Logo" /><span class="show-for-sr">Grassroots 365 Official Site</span></a>
            <a class="secondary-logo g365-logo title-logos cell shrink has-tip" href="https://sportsboardroom.com/" target="_blank"><img src="/wp-content/themes/shb-press/assets/tiny-logos/sports-boardroom.png" alt="Sports Boardroom Official Logo" /><span class="show-for-sr">Sports Boardroom Official Site</span></a> -->
          </div>
            ...
            <a class="secondary-logo g365-logo title-logos cell shrink has-tip" href="https://sportsboardroom.com/" target="_blank"><img src="/wp-content/themes/shb-press/assets/tiny-logos/sports-boardroom.png" alt="Sports Boardroom Official Logo" /><span class="show-for-sr">Sports Boardroom Official Site</span></a> -->
				...
				<nav id="site-header-menu" class="site-header-menu cell small-6 medium-5 header-bg" role="navigation" aria-label="Partners and Title Navigation">
					...
					<div id="main-nav-drawer" class="nav-drawer" style="display: none;" data-toggler data-closable="slide-out-left" data-animate="slide-in-left">
						...
						<a class="main-logo-menu main-logo shb-logo show-for-small-only" href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img src="<?php echo get_site_url(); ?>/wp-content/themes/shb-press/assets/tiny-logos/Strictly-Hoops-Logo-400x300.png" alt="<?php bloginfo( 'name' ); ?>" /><span class="show-for-sr"><?php bloginfo( 'name' ); ?></span></a>
